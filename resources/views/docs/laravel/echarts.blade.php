...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/echarts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:21 GMT -->

<head>

  <meta charset="utf-8" />
  <title>E Chart Js | Velzon Laravel - Admin & Dashboard Template Documentation</title>
          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">E Chart Js</h4>

                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Docs</a></li>
                    <li class="breadcrumb-item active">E Chart Js</li>
                  </ol>
                </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h5 class="fw-semibold">Overview<a href="https://echarts.apache.org/handbook/en/get-started/"
                      target="_blank" class="float-end badge badge-soft-success">Official Website <i
                        class="ri-external-link-line"></i></a> </h5>
                  <p class="text-muted mb-4">ECharts, a powerful, interactive charting and visualization library for
                    browser.</p>

                  <h6 class="mt-3">Javascript</h6>
                  <pre><code class="language-markup">&lt;!-- echarts js --&gt;
&lt;script src=&quot;{{ URL::asset('build/libs/echarts/echarts.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                  <h6 class="mt-3">Initjs (Custom js)</h6>
                  <pre><code class="language-markup">&lt;!-- echarts init --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/echarts.init.js') }}&quot;&gt;&lt;/script&gt; 
</code></pre>

                  <h6 class="mt-3">Add Package</h6>
                  <pre><code class="language-markup">npm i echarts --save</code></pre>

                  <h6 class="mt-3">Remove Package</h6>
                  <pre><code class="language-markup">npm unistall echarts or you can remove package by removing specific package from package.json</code></pre>
                ...
                <div class="card-body border-top border-2 border-top-dashed">
                  ...
                  <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">Mandotary code to get color array from string for every chart.</th>
                          <td>
              ...
              if(val.length == 2){
                  ...
                  return newValue;
                        ...
                        <tr>
                          ...
                          <td>
                            <pre><code class="language-js">var chartLineColors = getChartColorsArray("chart-line");
...
if (option && typeof option === "object") {
    option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Stacked Line Chart</th>
                          <td>
                            <pre><code class="language-js">var chartLineStackedColors = getChartColorsArray("chart-line-stacked");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Area Chart</th>
                          <td>
                            <pre><code class="language-js">var chartAreaColors = getChartColorsArray("chart-area");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Stacked Area Chart</th>
                          <td>
                            <pre><code class="language-js">var chartAreaStackedColors = getChartColorsArray("chart-area-stacked");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Step Line</th>
                          <td>
                            <pre><code class="language-js">var chartStepLineColors = getChartColorsArray("chart-step-line");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Line Y Category</th>
                          <td>
                            <pre><code class="language-js">var chartLineYColors = getChartColorsArray("chart-line-y-category");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Basic Bar</th>
                          <td>
                            <pre><code class="language-js">var chartBarColors = getChartColorsArray("chart-bar");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          ...
                          <td>
                            <pre><code class="language-js">var chartBarHorizontalColors = getChartColorsArray("chart-horizontal-bar");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Stacked Horizontal Bar</th>
                          <td>
                            <pre><code class="language-js">var chartBarStackedColors = getChartColorsArray("chart-horizontal-bar-stacked");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          ...
                          <td>
                            <pre><code class="language-js">var chartPieColors = getChartColorsArray("chart-pie");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Doughnut Chart</th>
                          <td>
                            <pre><code class="language-js">var chartDoughnutColors = getChartColorsArray("chart-doughnut");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Basic Scatter Chart</th>
                          <td>
                            <pre><code class="language-js">var chartScatterColors = getChartColorsArray("chart-scatter");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Candlestick Chart</th>
                          <td>
                            <pre><code class="language-js">var chartCandlestickColors = getChartColorsArray("chart-candlestick");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Graph Chart</th>
                          <td>
                            <pre><code class="language-js">var chartGraphColors = getChartColorsArray("chart-graph");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Treemap Chart</th>
                          <td>
                            <pre><code class="language-js">var chartTreemapColors = getChartColorsArray("chart-treemap");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Sunburst Chart</th>
                          <td>
                            <pre><code class="language-js">var chartSunburstColors = getChartColorsArray("chart-sunburst");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Parallel Chart</th>
                          <td>
                            <pre><code class="language-js">var chartParallelColors = getChartColorsArray("chart-parallel");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Sankey Chart</th>
                          <td>
                            <pre><code class="language-js">var chartSankeyColors = getChartColorsArray("chart-sankey");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Funnel Chart</th>
                          <td>
                            <pre><code class="language-js">var chartFunnelColors = getChartColorsArray("chart-sankey");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Gauge Chart</th>
                          <td>
                            <pre><code class="language-js">var chartGaugeColors = getChartColorsArray("chart-gauge");
...
option && myChart.setOption(option);
                        ...
                        <tr>
                          <th scope="row">Heatmap Chart</th>
                          <td>
                            <pre><code class="language-js">var chartHeatmapColors = getChartColorsArray("chart-heatmap");
