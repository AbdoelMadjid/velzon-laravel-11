...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/input-mask.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:18 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Cleave.js-Input Mask | Velzon Laravel - Admin & Dashboard Template Documentation</title>
...
&lt;script src=&quot;{{ URL::asset('build/libs/cleave.js/cleave.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- form masks init --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/form-masks.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i cleave.js --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall cleave.js or you can remove package by removing specific package from package.json</code></pre>
