...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/autocomplete.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:19 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Autocomplete | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fw-semibold">Overview<a
                                            href="https://tarekraafat.github.io/autoComplete.js/" target="_blank"
                                            class="float-end badge badge-soft-success">Official Website <i
                                                class="ri-external-link-line"></i></a> </h5>
                                    <p class="text-muted mb-4">The Autocomplete widgets provides suggestions while you
                                        type into the
                                        field.The datasource is a simple JavaScript array, provided to the widget using
                                        the source-option.</p>

                                    <h6>CSS</h6>
                                    <pre><code class="language-markup">&lt;!-- autocomplete css --&gt;
&lt;link rel=&quot;stylesheet&quot; href=&quot;{{ URL::asset('build/libs/@tarekraafat/autocomplete.js/css/autoComplete.css') }}&quot;&gt;
</code></pre>

                                    <h6 class="mt-3">Javascript</h6>
                                    <pre><code class="language-markup">&lt;!-- autocomplete js --&gt;
&lt;script src=&quot;{{ URL::asset('build/libs/@tarekraafat/autocomplete.js/autoComplete.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>
...
&lt;script src=&quot;{{ URL::asset('build/js/pages/form-advanced.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>
                                    ...
                                    <pre><code class="language-markup">npm i @tarekraafat/autocomplete.js --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall @tarekraafat/autocomplete.js or you can remove package by removing specific package from package.json</code></pre>
