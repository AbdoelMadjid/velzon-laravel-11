...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/chartjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:21 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Chart Js | Velzon Laravel - Admin & Dashboard Template Documentation</title>
...
&lt;script src=&quot;{{ URL::asset('build/libs/chart.js/chart.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>
...
&lt;script src=&quot;{{ URL::asset('build/js/pages/chartjs.init.js') }}&quot;&gt;&lt;/script&gt;  
                                    ...
                                    <pre><code class="language-markup">npm i chart.js --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall chart.js or you can remove package by removing specific package from package.json</code></pre>
                                ...
                                <div class="card-body border-top border-2 border-top-dashed">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row">Mandotary code to get color array from string for
                                                        every
                                                        chart.</th>
                                                    <td>
