...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/simplebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:17 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Simplebar | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-4">SimpleBar does only one thing: replace the browser's
                                        default
...
&lt;script src=&quot;{{ URL::asset('build/libs/simplebar/simplebar.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>


                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i simplebar --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall simplebar or you can remove package by removing specific package from package.json</code></pre>
