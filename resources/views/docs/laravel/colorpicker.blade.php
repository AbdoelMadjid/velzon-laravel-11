...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/colorpicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:18 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Color pickr | Velzon Laravel - Admin & Dashboard Template Documentation</title>
...
&lt;script src=&quot;{{ URL::asset('build/libs/@simonwep/pickr/pickr.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!--  color pickr init js --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/form-pickers.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i @simonwep/pickr --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall @simonwep/pickr or you can remove package by removing specific package from package.json</code></pre>
