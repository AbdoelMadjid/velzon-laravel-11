...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/css.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:04 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Customization CSS | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Customization CSS</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Docs</a></li>
                                        <li class="breadcrumb-item active">Customization CSS</li>
                                    </ol>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <p class="text-muted mb-4">If you do not want to use SASS then you can
                                                directly
                                                change the
                                                <code>custom.min.css</code> file. We suggest you not make any changes in
                                                the
                                                app,
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    <li class="p-0 parent-title"><a href="javascript: void(0);"
                                                            class="fw-medium fs-14"><img
                                                                ...
                                                                class="folder-icon me-1" alt="">laravel</a>
                                                    </li>
                                                    <li>
