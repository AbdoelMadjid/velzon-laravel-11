...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/flatpickr.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:18 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Flatpickr | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-4">flatpickr is a lightweight and powerful datetime picker.
                                    </p>


                                    <h6 class="mt-3">Javascript</h6>
                                    <pre><code class="language-markup">&lt;!-- flatpickr.js --&gt;
&lt;script type='text/javascript' src='{{ URL::asset('build/libs/flatpickr/flatpickr.min.js') }}'&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Note</h6>
                                    <pre><code class="language-markup">Flatpickr js file is loaded in &lt;script src=&quot;{{ URL::asset('build/js/pluggins.js') }}&quot;&gt;&lt;/script&gt;.</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- app js --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/app.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i flatpickr --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall flatpickr or you can remove package by removing specific package from package.json</code></pre>
                                </div>
                                <!-- end card-body -->
