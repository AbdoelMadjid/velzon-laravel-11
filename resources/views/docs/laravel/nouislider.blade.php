...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/nouislider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:19 GMT -->

<head>

    <meta charset="utf-8" />
    <title>noUiSlider | Velzon Laravel - Admin & Dashboard Template Documentation</title>
...
&lt;script src=&quot;{{ URL::asset('build/libs/nouislider/nouislider.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- range slider init --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/range-sliders.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i nouislider --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall nouislider or you can remove package by removing specific package from package.json</code></pre>
