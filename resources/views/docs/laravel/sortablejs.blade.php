...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/sortablejs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:17 GMT -->

<head>

    <meta charset="utf-8" />
    <title>SortableJS | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-4">SortableJS JavaScript library for reorderable
                                        drag-and-drop
                                        lists.</p>
...
&lt;script src=&quot;{{ URL::asset('build/libs/sortablejs/Sortable.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- nestable init js --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/nestable.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i sortablejs --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm uninstall sortablejs or you can remove package by removing specific package from package.json</code></pre>
