...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/gridjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:20 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Grid Js | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-4">Grid.js is a Free and open-source JavaScript table
                                        plugin. It
...
&lt;script src=&quot;{{ URL::asset('build/libs/gridjs/gridjs.umd.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- gridjs init --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/gridjs.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i gridjs --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall gridjs or you can remove package by removing specific package from package.json</code></pre>
