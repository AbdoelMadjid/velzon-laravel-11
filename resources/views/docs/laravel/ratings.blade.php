...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/ratings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:17 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Raterjs-Ratings | Velzon Laravel - Admin & Dashboard Template Documentation</title>
...
&lt;script src=&quot;{{ URL::asset('build/libs/rater-js/index.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- rating init --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/rating.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i rater-js --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistallrater-js or you can remove package by removing specific package from package.json</code></pre>
