...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/detached.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:13 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Detached | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p class="text-muted">Use below given attribute to set Detached layout
                                                style(Applicable in Vertical
                                                layout only).</p>
                                            ...
                                            <p class="text-muted">
                                                ...
                                                <code>resources/views/layouts/master.blade.php</code> code into the
                                            ...
                                            <p class="text-muted mb-0">In order to add, change or remove menu items from
                                                ...
                                                The
                                                change
                                                would reflect in all the files automatically.</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted"> Please do the below change in the html element at
                                        <code>Velzon/admin/resources/views/layouts/layouts-detached.blade.php.</code>
                                        file.
                                        ex: <code>&lt;html data-layout-width="fluid"></code>
                                    </p>
                                    <h4 class="fs-15 fw-semibold mb-3">Layout Style</h4>
                                    <div class="row">
