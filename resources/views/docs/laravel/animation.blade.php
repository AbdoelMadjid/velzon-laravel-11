...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/animation.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:17 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Aos Animation | Velzon Laravel - Admin & Dashboard Template Documentation</title>
...
&lt;link rel=&quot;stylesheet&quot; href=&quot;{{ URL::asset('build/libs/aos/aos.css') }}&quot; /&gt;</code></pre>

                                    <h6 class="mt-3">Javascript</h6>
                                    <pre><code class="language-markup">&lt;!-- aos js --&gt;
&lt;script src=&quot;{{ URL::asset('build/libs/aos/aos.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- animation init --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/animation-aos.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i aos --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall aos or you can remove package by removing specific package from package.json</code></pre>
