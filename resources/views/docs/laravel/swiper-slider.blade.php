...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/swiper-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:17 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Swiper-Slider | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-4">Swiper is the most modern slider with hardware
                                        accelerated
                                        transitions and amazing native behavior.</p>

                                    <h6>CSS</h6>
                                    <pre><code class="language-markup">&lt;!--Swiper slider css--&gt;
&lt;link href=&quot;{{ URL::asset('build/libs/swiper/swiper-bundle.min.css') }}&quot; rel=&quot;stylesheet&quot; type=&quot;text/css&quot; /&gt;</code></pre>

                                    <h6 class="mt-3">Javascript</h6>
                                    <pre><code class="language-markup">&lt;!--Swiper slider js--&gt;
&lt;script src=&quot;{{ URL::asset('build/libs/swiper/swiper-bundle.min.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Initjs (Custom js)</h6>
                                    <pre><code class="language-markup">&lt;!-- swiper.init js --&gt;
&lt;script src=&quot;{{ URL::asset('build/js/pages/swiper.init.js') }}&quot;&gt;&lt;/script&gt;</code></pre>

                                    <h6 class="mt-3">Add Package</h6>
                                    <pre><code class="language-markup">npm i swiper --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre><code class="language-markup">npm unistall swiper or you can remove package by removing specific package from package.json</code></pre>
