...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/theme-setup.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:06 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Theme Setup | Velzon Laravel - Admin & Dashboard Template Documentation</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/default.png" alt="image"
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/saas.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/material.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/galaxy.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/corporate.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/minimal.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/creative.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/modern.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/interactive.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/classic.png" alt="image"
                                                    class="img-fluid shadow mb-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="border p-3 text-center mb-3">
                                                <img src="../../assets/images/demo/vintage.png" alt="image"
                                                    class="img-fluid shadow mb-3">
...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/theme-setup.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:08 GMT -->
