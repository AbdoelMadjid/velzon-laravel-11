...
<!-- Mirrored from themesbrand.com/velzon/docs/laravel/leaflet.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2026 17:21:21 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Leaflet | Velzon Laravel - Admin & Dashboard Template Documentation</title>
...
&lt;script src=&quot;{{ URL::asset('build/libs/leaflet/leaflet.js') }}&quot;&gt;&lt;/script&gt;</code></pre>
...
&lt;script src=&quot;{{ URL::asset('build/js/pages/leaflet-map.init.js') }}&quot;&gt;&lt;/script&gt;
                                    ...
                                    <pre><code class="language-markup">npm i leaflet --save</code></pre>

                                    <h6 class="mt-3">Remove Package</h6>
                                    <pre class="mb-3"><code class="language-markup">npm unistall leaflet </code></pre>
...
var greenIcon = new LeafIcon({iconUrl: 'build/images/logo-sm.png'});
